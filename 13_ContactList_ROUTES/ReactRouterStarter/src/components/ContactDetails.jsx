  ...
  return (
    <>
      ...
      {error !== null ? (
        ...
        <div
          className="flex flex-col items-center my-16 mx-2 md:w-1/2 lg:w-2/5 
            md:mx-auto shadow-xl bg-gray-50 rounded  pt-8 p-4 px-8"
        >
          <div className="flex flex-col items-center ">
            {/* Start of Head Shot*/}
            <div
              className="flex flex-col justify-center w-64 h-64 bg-gray-300 
              border-gray-300 rounded-full border-2 shadow-xl text-center p-8 -m-32"
            >
              <figure>
                <img
                  className="m-auto"
                  alt="contact's head shot"
            ...
            {!editing ? (
              <div
                ...
                justify-items-center mt-32 pt-8"
              >
                {/* Company */}
