  ...
  return (
    <>
      <nav className="md:w-3/4 m-auto mt-8">
        <button
          aria-label="Navigates back to home page"
          onClick={() => navigate("/")}
        >
          <svg
      ...
      <h1
        className="w-full bg-green-600 text-gray-100 text-center py-4 text-4xl 
            uppercase tracking-wide mt-20 md:w-1/2 mx-auto rounded-t-md"
      >
        Add New Contact
      </h1>
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="col-span-full text-lg border-2 text-gray-100 border-green-600 
            bg-green-600 hover:bg-gray-50 hover:border-green-600  hover:text-green-600 
            hover:shadow-2xl  lg:w-2/5  justify-self-center rounded-full py-3 px-4 shadow-lg"
        >
          Add Contact
        </button>
      </form>
